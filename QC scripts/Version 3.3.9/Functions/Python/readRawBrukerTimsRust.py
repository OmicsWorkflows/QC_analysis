...
def readRawBrukerTims(path, sample, msn,  qc_path, mz_tol, tic_output, bpc_output, qc_output, qc_only, info_path):
...
if __name__ == '__main__':
    ...
    try:
        readRawBrukerTims(path, sample, msn, qc_path, mz_tol, tic_output, bpc_output, qc_output, qc_only, info_path)
        print('ok')
    except:
        print('error')