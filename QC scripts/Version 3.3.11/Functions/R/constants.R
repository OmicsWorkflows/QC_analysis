...
# Colors for curves
qcColors <- c('mediumvioletred', 'lightseagreen','lightslategrey','black','firebrick', 'forestgreen', 'navy', 'gold3')
lcColors <- data.frame(type = c('EIC', 'MPC', 'LC', 'LC', 'LC', 'LC'),
                       subtype = c(NA, NA, 'LP pump', 'NC pump', 'pump A', 'pump B'),
                       colors = c('darkorchid', 'darkorange3', 'navy', 'gold3', 'navy', 'gold3'))
ticColors <- data.frame(type = c('TIC', 'TIC', 'BPC'),
                        level = c('MS', 'MS2', 'MS'),
                        colors = c('black', 'firebrick', 'forestgreen'))
